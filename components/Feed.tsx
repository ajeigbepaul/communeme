...
function Feed({tweets:tweetsProp}:Props) {
  ...
  return (
    <div className="flex flex-col col-span-7 lg:col-span-5 border-x max-h-screen overflow-y-scroll scrollbar-track-gray-400/20 scrollbar-thumb-[#2684de]/80 scrollbar-thin">
